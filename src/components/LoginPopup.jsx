...
function LoginPopup({className},ref) {
  ...
  return (
    <div className={`p-2 border border-emerald-700 flex flex-col rounded-md bg-white ${className}`}>
      <button className='bg-emerald-500 px-2 m-auto mb-1 active:bg-emerald-500 hover:bg-emerald-600 text-white font-nunito text-md font-semibold rounded-sm' onClick={()=>handleLogin()}>Login</button>
